...
export const BLOGS: BlogPost[] = [
  {
    ...
    excerpt:
      'The problem Thrive Pakistan was created to solve is not a lack of ambition, but a lack of proximity.',
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      'Closing the distance takes repetition: exposure that leads to skills, skills that build networks, networks that convert into internships, jobs, freelance work, mentorship, and startup support, plus a structure that keeps the network active between events.',
      'That is the model Thrive Pakistan is building in Hazara and Khyber Pakhtunkhwa: five layers, exposure, skills, network, opportunity, and ecosystem, each moving participants closer to a usable outcome.',
    ],
    author: 'Thrive Pakistan',
    authorRole: 'Organizational editorial',
    date: '2026-08-05',
